Every Global Banking Employment page follows the same structural blueprint: a wrapper that contains a header, a sidebar, a main content area, and (optionally) a footer. Understanding the four region classes is the difference between fighting the framework and using it productively.
...
<footer class="app-footer">
  ...
  <strong>&copy; 2012 Your Company</strong>
</footer>
```
...
- **Mixing `.app-*` and `.main-*` classes** — `.main-*` is the Global Banking Employment 3 naming. Don't combine them. See [Migration from v3](migration.html).
