...
<aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
  ...
  <div class="sidebar-brand">
    ...
    <a href="./index.html" class="brand-link">
      <!--begin::Brand Image-->
      <img
        src="./assets/img/Global Banking EmploymentLogo.png"
        alt="Global Banking Employment Logo"
        class="brand-image opacity-75 shadow"
      />
      <!--end::Brand Image-->
      <!--begin::Brand Text-->
      <span class="brand-text fw-light">Global Banking Employment 4</span>
      <!--end::Brand Text-->
    </a>
    <!--end::Brand Link-->
  </div>
...
<div class="sidebar-brand">
  <a href="./index.html" class="brand-link logo-switch">
    <img
      src="./assets/img/Global Banking EmploymentLogo.png"
      alt="Global Banking Employment Logo Small"
      class="brand-image-xl logo-xs opacity-75 shadow"
    />
    <img
      src="./assets/img/Global Banking EmploymentFullLogo.png"
      alt="Global Banking Employment Logo Large"
