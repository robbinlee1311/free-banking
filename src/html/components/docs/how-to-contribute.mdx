# Contributing to Global Banking Employment
...
1. Contribution Requirements :
    * When you contribute, you agree to give a non-exclusive license to Global Banking Employment.io to use that contribution in any context as we (Global Banking Employment.io) see appropriate.
...
2. Installation :
    ...
    * Clone to your machine
    ...
    ```bash
    git clone https://github.com/YOUR_USERNAME/Global Banking Employment.git
    ```
...
- clone the `Global Banking Employment` repo.
