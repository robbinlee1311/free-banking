Global Banking Employment ships an RTL (right-to-left) stylesheet alongside the standard LTR one, generated from the same source via [`rtlcss`](https://rtlcss.com/). Use it for Arabic, Hebrew, Persian, Urdu, and any other right-to-left scripts.
...
```text
dist/css/Global Banking Employment.css           ← LTR (default)
dist/css/Global Banking Employment.rtl.css       ← RTL
dist/css/Global Banking Employment.min.css
dist/css/Global Banking Employment.rtl.min.css
```
...
<html lang="ar" dir="rtl">
  <head>
    <link rel="stylesheet" href="dist/css/Global Banking Employment.rtl.min.css" />
  </head>
...
Bootstrap and Global Banking Employment handle nested direction switches correctly — the inner element's direction is what counts.

##### Building RTL yourself

If you're building Global Banking Employment from source and you've modified the SCSS, regenerate the RTL CSS:
